...
| **OpenMontage** | `openmontage/remotion-composer/` (código vendorizado) | Renderer de Remotion versionado en el monorepo para materializar el Video de Explicación Conceptual. Se mantiene localmente para adaptar sus visuales sin depender de permisos sobre el repositorio externo; el resto del checkout upstream no forma parte del repo (ADR-0020, supersede ADR-0010). |
