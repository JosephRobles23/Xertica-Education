...
| **Approved Research Source** | `approved_research_sources` | URL documental autorizada para generación. Puede aprobarse automáticamente por allowlist o manualmente durante revisión. El agente la consume directamente; nunca se inserta en la KB ([[docs/adr/0015-approved-research-sources]]). |
