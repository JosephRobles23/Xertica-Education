    ...
    sources: [
      {
        ...
        vendor: 'Google',
        verificationReason: 'Video específico del canal permitido para Google: Google',
        relevanceScore: 94,
        suggestedUse: 'lab',
        quote: 'Video específico recomendado para introducir Nano Banana desde un canal oficial.',
        videoPreview: { channel: 'Google', duration: '01:54', gradient: 'from-pink-500 via-rose-400 to-orange-300', emoji: '🎨', youtubeId: 'AeBOzler4nE', videoTitle: 'Meet Nano Banana Pro: Next-Level AI Image Generation & Editing' },
      },
      {
        ...
        relevanceScore: 93,
        suggestedUse: 'video',
        quote: 'Video específico recomendado para enseñar Flow/Veo desde un canal oficial.',
        videoPreview: { channel: 'Google', duration: '06:42', gradient: 'from-indigo-600 via-sky-500 to-teal-400', emoji: '🎬', youtubeId: '9nVEfjmDlVk', videoTitle: "Creating in Flow | How to use Google's new AI Filmmaking Tool" },
      },
      {
        title: 'Documentación oficial para prompts visuales',
        plat: 'ai.google.dev',
        kind: 'documentation',
        ...
        toolName: 'Nano Banana',
        vendor: 'Google',
        verificationReason: 'Dominio oficial permitido para Google: ai.google.dev',
        relevanceScore: 89,
        suggestedUse: 'lesson',
        quote: '“Describe luz, composición y emoción antes que el objeto.”',
      },
      {
        title: 'Veo: documentación oficial de generación de video',
        plat: 'ai.google.dev',
        kind: 'documentation',
        ...
        relevanceScore: 90,
        suggestedUse: 'lesson',
        quote: 'Referencia oficial concreta para explicar capacidades, límites y flujo de generación de video.',
      },
      {
        title: 'Tendencias de diseño generativo 2026',
        plat: 'Blog externo',
        kind: 'article',
        verified: false,
        status: 'requires-review',
        toolName: 'Fuentes generales',
        vendor: 'Externo',
        verificationReason: 'No coincide con un canal o dominio permitido; requiere revisión humana.',
        relevanceScore: 64,
        suggestedUse: 'general',
        quote: '“El estilo híbrido humano-máquina domina las campañas premiadas.”',
      },
    ],
    pack: {
      lesson: {
