...
*   **Gate 2 — Script & Storyboard (Aprobación de Guion):** Antes de ejecutar los costosos procesos de renderizado de video, el autor revisa el guion segmentado y los bosquejos visuales. Se valida el cumplimiento de las restricciones de tiempo y presupuesto de palabras.
