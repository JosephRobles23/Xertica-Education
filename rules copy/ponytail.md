# Ponytail (Modo minimalista)

> **Trigger:** Always active. Also: user says "ponytail", "lazy", "simplest", "minimal", "yagni", or complains about over-engineering.
> **Intensity:** lite | full (default) | ultra. "stop ponytail" / "normal mode" to deactivate.
...
Non-trivial logic leaves ONE runnable check: an assert-based self-check or one small test.
